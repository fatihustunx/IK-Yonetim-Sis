...
public class Application {
	...
	public static void main(String[] args) throws Exception {
		...
		/*
		ProgrammingLanguageService programmingLanguageService = new ProgrammingLanguageManager(
				new InMemoryProgrammingLanguageRepository(), new ProgrammingLanguageCheckManager());
		...
		programmingLanguageService.add(pL);
		// programmingLanguageService.add(pL2);
		// programmingLanguageService.add(pL3);
		// programmingLanguageService.add(pL4);

		List<ProgrammingLanguage> temp = programmingLanguageService.getAll();
		for (ProgrammingLanguage pl : temp) {
		...
		temp = programmingLanguageService.getAll();
		for (ProgrammingLanguage pl : temp) {
			System.out.println(pl.getName());
		}
